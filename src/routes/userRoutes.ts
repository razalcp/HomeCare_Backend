...
const userReprository = new UserReprository(User, DoctorModel as any, SlotModel as any, BookingModel as any, doctorWalletModel as any, AdminWalletModel as any, userWalletModel as any);
...
router.patch('/updateUserProfile', authMiddleware, upload.any(), userController.updateUser)
